...
const alphaNums = new Set('abcdefghijklmnopqrstuvwxyz'
...
export function registerKeyStroke(data, text) {
    ...
    if (origin === '+delete') {
        ...
        if (alphaNums.has(preCh)
            && (!alphaNums.has(txtLn.charAt(chNum))
                || chNum === txtLn.length)) {
